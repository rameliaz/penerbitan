...
* ***Postprint*** — versi naskah yang sudah ditinjau sejawat tetapi belum ditata letak sesuai gaya selingkung (_in-house style_) penerbit terbitan berkala ilmiah.
...
![](libs/monograf.PNG){fig-align="center" width="80%"}
...
* ***Target article***
  - _Target article_ → _Commentary_ → _Rejoinder_
...
::: {.callout-warning}
#### Penting 
Terindeks di Scopus ≠ berkualitas tinggi. Tidak terindeks = sinyal untuk waspada.
:::
