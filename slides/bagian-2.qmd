...
*"Penelitian ini memiliki terlalu banyak keterbatasan sehingga temuannya tidak dapat digeneralisasi di konteks masyarakat yang lebih luas. Oleh karena itu, kontribusi hasil penelitian ini sangat terbatas mendeskripsikan therapeutic alliance pada konteks yang amat kecil, yaitu warga di kecamatan Gubeng."*
:::
:::
::: {.column}
::: {.callout-note}
...
*"Meski cakupan studi ini terbatas pada konteks Indonesia, temuan penelitian ini dapat membuka peluang untuk studi komparatif lintas budaya. Aspek validitas lintas budaya dan validitas ekologis dari therapeutic alliance merupakan pertanyaan yang selama ini kurang mendapat perhatian di literatur."*
:::
:::
::::
...
## Mengapa naskah di-*desk reject*? 1️⃣

::: {.incremental}
Berdasarkan panduan *submission* [*Psychological Science* (per 30 Januari 2026)](https://www.psychologicalscience.org/publications/psychological_science/ps-submissions), yang saya gunakan sebagai **contoh**, alasan *desk reject* pada *initial editorial review*:
...
## Mengapa naskah di-*desk reject*? 2️⃣
...
* **Lakukan *triage***: mana yang valid, mana yang perlu klarifikasi, mana yang tidak Anda setujui
...
* *Major revision* bukan penolakan, justru merupakan kesempatan untuk memperbaiki naskah
...
| *"belum ada penelitian..."* | *"pertanyaan ini belum mendapat perhatian yang memadai di litaratur..."* |
...
* **Peran promotor**: promotor memiliki tanggung jawab etik dalam proses publikasi mahasiswanya, bukan hanya formalitas pencantuman nama
  ...
  - Jangan menambahkan nama promotor/ko-promotor **tanpa persetujuan** ybs. sebelumnya
:::
...
* **Bagikan data ekstraksi** (*data extraction sheets*), jika memungkinkan, sebagai bentuk komitmen pada prinsip *open data*
  - Kalau menggunakan _software systematic review managemen_ seperti [ASReview Lab](https://asreview.nl/) atau [Rayyan](https://www.rayyan.ai/), maka jelaskan [_stopping rules_](https://onlinelibrary.wiley.com/doi/full/10.1002/jrsm.1762)-nya
...
## Contoh *disclosure* penggunaan LLM

![](libs/ai_disclosure_diss.png){fig-align="center" width="80%"}
![](libs/ai_disclosure.png){fig-align="center" width="80%"}
